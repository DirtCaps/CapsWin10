##################################################
# CapsWindows10 Tweaker2020
#
# DirtCaps by. Efe
# Surum: 1.2, 2020-08-04 (Surum)
#
$Script_Version = '1.2.0'
$Script_Date = '8-Nisan-2020'
$Release_Type = 'Tasinabilir'
##################################################

## !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
## !!                                            !!
## !!           CapsWindows10 Tweaker            !!
## !!              DirtCaps by. Efe              !!
## !!                                            !!
## !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
$Copyright =' DirtCaps by. Efe                                                  
 Surum: v1.2.0, 8-Nisan-2020                                                                                                                                        
 Yazilim (c) 2020-2021                                                                     
                                                                        '
<#--------------------------------------------------------------------------------
...
If([Environment]::OSVersion.Version.Major -ne 10) {
	Clear-Host
	Write-Host 'Uzugunum, Bu Uygulama Sadece Windows 10 icindir!' -ForegroundColor 'cyan' -BackgroundColor 'black'
	If($Automated -ne 1){ Read-Host -Prompt "`nKapatmak icin Tusa Basiniz..." } ;Exit
}

If($Release_Type -eq 'Tasinabilir'){ $ErrorActionPreference = 'SilentlyContinue' } Else{ $Release_Type = 'Testing' }
...
$AppxOptions=@('Atla','Goster','Gizle','Kaldir')
...
Function AnyKeyClose{ Read-Host -Prompt "`nKapatmak icin Tusa Basiniz..." }
...
Function UpdateCheck {
	If(InternetCheck) {
		...
		$CSVLine,$RT = If($Release_Type -eq 'Tasinabilir'){ 0,'' } Else{ 1,'Testing/' }
...
Function ScriptUpdateFun([String]$RT) {
	$Script_Url = $URL_Base + $RT + 'CapsWin10.ps1'
	$ScrpFilePath = $FileBase + 'CapsWin10.ps1'
...
Function TOSDisplay([Switch]$C) {
	If(!$C){ Clear-Host }
	$BorderColor = 14
	If($Release_Type -ne 'Tasinabilir') {
		$BorderColor = 15
		DisplayOut '|'.PadRight(22),'Risk!!!'.PadRight(31),'|' -C 15,13,15
		TOSBlankLine 15
		DisplayOut '|'.PadRight(17),'RISK SIZE AITTIR!'.PadRight(36),'|' -C 15,14,15
		TOSBlankLine 15
	}
	TOSLine $BorderColor
	DisplayOut '|'.PadRight(21),'  O K U'.PadRight(32),'|' -C $BorderColor,14,$BorderColor
	TOSLine $BorderColor
	DisplayOut '|',' CapsWindows10 Tweaker DirtCaps by. Efe'.PadRight(52),'|' -C $BorderColor,8,$BorderColor
	TOSBlankLine $BorderColor
	DisplayOut '|',' Bu Uygulamanin Amaci Windowsu Daha iyi             ','|' -C $BorderColor,8,$BorderColor
	DisplayOut '|',' Hale Getirmek icin Hazirlanmistir..                ','|' -C $BorderColor,8,$BorderColor
	TOSBlankLine $BorderColor
	DisplayOut '|',' Yapici ','by. Efe','                                     ','|' -C $BorderColor,8,13,8,$BorderColor
	TOSBlankLine $BorderColor
	DisplayOut '|',' Lutfen ','Evet Hayir',' Seceneklerle Devam Ediniz.       ','|' -C $BorderColor,8,13,8,$BorderColor
	TOSBlankLine $BorderColor
	TOSLine $BorderColor
}
...
Function TOS {
	...
	While($TOS -ne 'Out') {
		...
		$TOS = Read-Host "`nKabul Ediyor musunuz? (E)vet/(H)ayir"
		If($TOS -In 'h','hayir'){
			Exit
		} ElseIf($TOS -In 'e','evet') {
...
Function GuiStart {
	...
	Clear-Host
	DisplayOut 'Uygulama Acilirken, Lutfen Bekleyiniz...' -C 8
...
Title="CapsWindows10 Tweaker DirtCaps by. Efe (v.$Script_Version -$Script_Date" Height="420" Width="620" BorderBrush="Black" Background="White">
	<Window.Resources>
	...
	<Grid>
		...
		<Menu Grid.Row="0" VerticalAlignment="Top">
			<MenuItem Header="Yardim">
				<MenuItem Name="FeedbackButton" Header="Bildir"/>
				<MenuItem Name="FAQButton" Header="Oku"/>
				<MenuItem Name="AboutButton" Header="Hakkimda"/>
				<MenuItem Name="CopyrightButton" Header="Surum"/>
				<MenuItem Name="ContactButton" Header="Ulas"/>
			</MenuItem>
			<MenuItem Name="DonateButton" Header="iletisim" Background="#FFFFAD2F" FontWeight="Bold"/>
			<MenuItem Name="DirtCapsButton" Header="Site" Background="#FFFFDF4F" FontWeight="Bold"/>
		</Menu>
		<TabControl Name="TabControl" Grid.Row="1" BorderBrush="Gainsboro" TabStripPlacement="Left">
			...
			<TabItem Name="Options_Tab" Header="Uygulama Ayari">
				<Grid Background="#FFE5E5E5">
					...
					<GroupBox Header="Ayarlar" Grid.Row="0" Margin="2">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
							...
							<CheckBox Grid.Row="0" Grid.Column="0" Name="CreateRestorePoint_CB" Content="Yukleme Noktasi:" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="5"/>
							<TextBox Grid.Row="0" Grid.Column="1" Name="RestorePointName_Txt" HorizontalAlignment="Left" TextWrapping="Wrap" Text="Win10 Script Kur" VerticalAlignment="Center" Margin="5"/>
							<CheckBox Grid.Row="1" Grid.Column="0" Name="ShowSkipped_CB" Content="Atlananlari Goster" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="5"/>
							<CheckBox Grid.Row="2" Grid.Column="0" Grid.ColumnSpan="2" Name="Restart_CB" Content="Yeniden Baslat (Onerilir!)" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="5"/>
							<CheckBox Grid.Row="3" Grid.Column="0" Grid.ColumnSpan="2" Name="VersionCheck_CB" Content="Guncel Tut (Ayarlar Bozulabilir.)" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="5"/>
							<CheckBox Grid.Row="4" Grid.Column="0" Name="InternetCheck_CB" Content="interneti Atla" HorizontalAlignment="Left" VerticalAlignment="Center" Margin="5"/>
						</Grid>
					</GroupBox>
					<GroupBox Grid.Row="1" Header="Yedek / Gerial / Sifirla" Margin="2">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
							...
							<Button Grid.Row="0" Grid.Column="0" Name="Save_Setting_Button" Content="Ayalari Kaydet"/>
							<Button Grid.Row="0" Grid.Column="1" Name="Load_Setting_Button" Content="Ayalari Yukle"/>
							<Button Grid.Row="0" Grid.Column="2" Name="WinDefault_Button" Content="Windows Varsayilan*"/>
							<Button Grid.Row="0" Grid.Column="3" Name="ResetDefault_Button" Content="Hepsini Sifirla"/>
							<TextBlock Grid.Row="1" Grid.Column="0" Grid.ColumnSpan="4" HorizontalAlignment="Left" FontStyle="Italic" TextWrapping="Wrap" Text="Windows Varsayilan * / Uygulamalari veya OneDrive Yuklemesini Degistirmez!"/>
						</Grid>
					</GroupBox>
					<GroupBox Grid.Row="2" Header="Surum" Margin="2">
						<Grid>
			...
			<TabItem Name="Privacy_tab" Header="Gizlilik">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
						<ColumnDefinition Width="*"/>
						<ColumnDefinition Width="*"/>
			...
			<TabItem Name="SrvTweak_Tab" Header="Servis Ayarlari">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
						<ColumnDefinition Width="*"/>
						<ColumnDefinition Width="*"/>
			...
			<TabItem Name="Context_Tab" Header="Baglam Menusu, &#xD;&#xA;Baslat Menusu">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
						<ColumnDefinition Width="*"/>
						<ColumnDefinition Width="*"/>
					</Grid.ColumnDefinitions>
					<GroupBox Grid.Column="0" Header="Baglam Menusu" Margin="5">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
					...
					<GroupBox Grid.Column="1" Header="Baslat Menusu" Margin="5">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
			...
			<TabItem Name="TaskBar_Tab" Header="Gorev Cubugu">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
						<ColumnDefinition Width="2*"/>
						<ColumnDefinition Width="*"/>
			...
			<TabItem Name="Explorer_Tab" Header="Cesitli Ayar">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
			...
			<TabItem Name="Desktop_Tab" Header="Masaustu, Bilgisayarim">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
						<ColumnDefinition Width="*"/>
						<ColumnDefinition Width="*"/>
					</Grid.ColumnDefinitions>
					<GroupBox Grid.Column="0" Header="Masaustu" Margin="5">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
					...
					<GroupBox Grid.Column="1" Header="Bilgisayarim" Margin="5">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
							...
							<Label Content="**Kaldirmak Sorun Olabilir." Grid.Row="7" Grid.Column="0" Grid.ColumnSpan="2" HorizontalAlignment="Center" VerticalAlignment="Center"/>
						</Grid>
					</GroupBox>
				</Grid>
			</TabItem>
			<TabItem Name="Misc_Tab" Header="Foto Gosterici, &#xD;&#xA;Kilit Ekrani, DahaFazla">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
					...
					<Grid>
						<Grid Grid.Column="0">
							...
							<GroupBox Grid.Row="0" Header="Foto Gosterici" Margin="10">
								<Grid>
									<Grid.RowDefinitions>
										<RowDefinition Height="*"/>
										<RowDefinition Height="*"/>
							...
							<GroupBox Grid.Row="1" Header="Kilit Ekrani" Margin="5">
								<Grid>
									<Grid.RowDefinitions>
										<RowDefinition Height="*"/>
										<RowDefinition Height="*"/>
					...
					<GroupBox Grid.Column="1" Header="DahaFazla" Margin="5">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
			...
			<TabItem Name="WinApp_Tab" Header="Windows Uygulamalari">
				<DataGrid Name="dataGrid" FrozenColumnCount="2" AutoGenerateColumns="False" AlternationCount="2" HeadersVisibility="Column" CanUserResizeRows="False" CanUserAddRows="False" IsTabStop="True" IsTextSearchEnabled="True" SelectionMode="Extended">
					...
					<DataGrid.Columns>
						<DataGridTextColumn Header="Gorunen Ad" Width="150" Binding="{Binding CName}" CanUserSort="True" IsReadOnly="True"/>
						<DataGridTemplateColumn Header="Ayar" Width="80" SortMemberPath="AppSelected" CanUserSort="True">
						...
						<DataGridTextColumn Header="Uygulama Adi" Width="180" Binding="{Binding AppxName}" IsReadOnly="True"/>
					</DataGrid.Columns>
				</DataGrid>
			</TabItem>
			<TabItem Name="Application_Tab" Header="Uygulamalar, &#xD;&#xA;Windows Guncelleme">
				<Grid Background="#FFE5E5E5">
					<Grid.ColumnDefinitions>
						<ColumnDefinition Width="*"/>
						<ColumnDefinition Width="*"/>
					</Grid.ColumnDefinitions>
					<GroupBox Grid.Column="0" Header="Uygulamalar/Eklenti" Margin="5">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
					...
					<GroupBox Grid.Column="1" Header="Windows Guncelleme" Margin="5">
						<Grid>
							<Grid.RowDefinitions>
								<RowDefinition Height="*"/>
								<RowDefinition Height="*"/>
		...
		<Button Name="RunScriptButton" Grid.Row="2" Content="Uygula" VerticalAlignment="Bottom" Height="20" FontWeight="Bold"/>
	</Grid>
</Window>
"@
	...
	$WPF_DirtCapsButton.Add_Click{ OpenWebsite 'https://www.twitch.tv/dirtc4ps' }
	$WPF_FeedbackButton.Add_Click{ OpenWebsite "$MySite" }
	$WPF_FAQButton.Add_Click{ OpenWebsite "Oku.txt" }
	...
	$WPF_AboutButton.Add_Click{ [Windows.Forms.Messagebox]::Show('Bu Program Powershell Kodlariyla Desteklenmektedir.. [DirtCaps by. Efe]','About', 'OK') | Out-Null }
...
$Skip_InstalledD_Uninstall = @('OneDriveInstall','MediaPlayer','WorkFolders','FaxAndScan')
	...
	ForEach($Var In $Skip_EnableD_Disable){ SetCombo $Var 'Ac*,Kapat' }
	ForEach($Var In $Skip_Enable_DisableD){ SetCombo $Var 'Ac,Kapat*' }
	ForEach($Var In $Skip_ShowD_Hide_Remove){ SetCombo $Var 'Goster/Ekle*,Gizle,Kaldir**' }
	ForEach($Var In $Skip_ShowD_Hide){ SetCombo $Var 'Goster*,Gizle' }
	ForEach($Var In $Skip_Show_HideD){ SetCombo $Var 'Goster,Gizle*' }
	ForEach($Var In $Skip_InstalledD_Uninstall){ SetCombo $Var 'Kur*,Kaldir' }

	SetCombo 'LinuxSubsystem' 'Yukle,Kaldir*'
	SetCombo 'HibernatePower' 'Acik,Kapat*'
	SetCombo 'UAC' 'Kapat*,Normal,Yuksek'
	SetCombo 'BatteryUIBar' 'Yeni*,Klasik'
	SetCombo 'ClockUIBar' 'Yeni*,Klasik'
	SetCombo 'VolumeControlBar' 'Yeni(Horizontal)*,Klasik(Vertical)'
	SetCombo 'TaskbarIconSize' 'Normal*,Kucuk'
	SetCombo 'TaskbarGrouping' 'Asla,Herzaman*,Bazen'
	SetCombo 'TrayIcons' 'Otomatik*,Herzaman'
	...
	SetCombo 'RecentFileQikAcc' 'Goster/Ekle*,Gizle,Kaldir'
	SetCombo 'WinXPowerShell' 'PowerShell,CMD'
	...
	ConfigGUIitms
	$Form.Title += If($Release_Type -ne 'Tasinabilir'){ " -$Release_Type)" } Else{ ')' }
	If($Release_Type -eq 'Tasinabilir'){ Clear-Host }
	DisplayOut 'Uyulama Calisiyor!' -C 14
	DisplayOut "`nBuraya Kapatirsaniz Uygulamada Kapanir!!" -C 8
...
Function RunScript {
	...
	If($Telemetry -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Telemetry...' -C 15 }
	} ElseIf($Telemetry -eq 1) {
		DisplayOut 'Aciliyor Telemetry...' -C 11
		...
		DisplayOut 'Kapatiliyor Telemetry...' -C 12
		Set-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\DataCollection' -Name 'AllowTelemetry' -Type DWord -Value 0
		Set-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection' -Name 'AllowTelemetry' -Type DWord -Value 0
		If($OSBit -eq 64){ Set-ItemProperty -Path 'HKLM:\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Policies\DataCollection' -Name 'AllowTelemetry' -Type DWord -Value 0 }
	...
	If($WiFiSense -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Wi-Fi Sense...' -C 15 }
	} ElseIf($WiFiSense -eq 1) {
		DisplayOut 'Aciliyor Wi-Fi Sense...' -C 11
		...
		DisplayOut 'Kapatiliyor Wi-Fi Sense...' -C 12
		$Path1 = 'HKLM:\SOFTWARE\Microsoft\PolicyManager\default\WiFi'
		$Path = CheckSetPath "$Path1\AllowWiFiHotSpotReporting"
	...
	If($SmartScreen -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor SmartScreen Filter...' -C 15 }
	} ElseIf($SmartScreen -eq 1) {
		DisplayOut 'Aciliyor SmartScreen Filter...' -C 11
		...
		DisplayOut 'Kapatiliyor SmartScreen Filter...' -C 12
	...
	If($LocationTracking -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Location Tracking...' -C 15 }
	} ElseIf($LocationTracking -eq 1) {
		DisplayOut 'Aciliyor Location Tracking...' -C 11
		Set-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Overrides\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}' -Name 'SensorPermissionState' -Type DWord -Value 1
		Set-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\lfsvc\Service\Configuration' -Name 'Status' -Type DWord -Value 1
	} ElseIf($LocationTracking -eq 2) {
		DisplayOut 'Kapatiliyor Location Tracking...' -C 12
		Set-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Sensor\Overrides\{BFA794E4-F964-4FDB-90F6-51056BFE4B44}' -Name 'SensorPermissionState' -Type DWord -Value 0
		Set-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\lfsvc\Service\Configuration' -Name 'Status' -Type DWord -Value 0
	}

	If($Feedback -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Feedback...' -C 15 }
	} ElseIf($Feedback -eq 1) {
		DisplayOut 'Aciliyor Feedback...' -C 11
		Remove-ItemProperty -Path 'HKCU:\SOFTWARE\Microsoft\Siuf\Rules' -Name 'NumberOfSIUFInPeriod'
	} ElseIf($Feedback -eq 2) {
		DisplayOut 'Kapatiliyor Feedback...' -C 12
	...
	If($AdvertisingID -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Advertising ID...' -C 15 }
	} ElseIf($AdvertisingID -eq 1) {
		DisplayOut 'Aciliyor Advertising ID...' -C 11
		...
		DisplayOut 'Kapatiliyor Advertising ID...' -C 12
	...
	If($Cortana -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Cortana...' -C 15 }
	} ElseIf($Cortana -eq 1) {
		DisplayOut 'Aciliyor Cortana...' -C 11
		...
		DisplayOut 'Kapatiliyor Cortana...' -C 12
	...
	If($CortanaSearch -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Cortana Search...' -C 15 }
	} ElseIf($CortanaSearch -eq 1) {
		DisplayOut 'Aciliyor Cortana Search...' -C 11
	...
	If($DiagTrack -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Diagnostics Tracking...' -C 15 }
	} ElseIf($DiagTrack -eq 1) {
		DisplayOut 'Aciliyor and Baslatiliyor Diagnostics Tracking Service...' -C 11
		Set-Service 'DiagTrack' -StartupType Automatic
		Start-Service 'DiagTrack'
	} ElseIf($DiagTrack -eq 2) {
		DisplayOut 'Durduruluyor and Kapatiliyor Diagnostics Tracking Service...' -C 12
		Stop-Service 'DiagTrack'
		Set-Service 'DiagTrack' -StartupType Disabled
	}

	If($WAPPush -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor WAP Push...' -C 15 }
	} ElseIf($WAPPush -eq 1) {
		DisplayOut 'Aciliyor and Baslatiliyor WAP Push Service...' -C 11
		Set-Service 'dmwappushservice' -StartupType Automatic
		Start-Service 'dmwappushservice'
		Set-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\dmwappushservice' -Name 'DelayedAutoStart' -Type DWord -Value 1
	} ElseIf($WAPPush -eq 2) {
		DisplayOut 'Kapatiliyor WAP Push Service...' -C 12
		Stop-Service 'dmwappushservice'
		Set-Service 'dmwappushservice' -StartupType Disabled
	}

	If($AppAutoDownload -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor App Auto Download...' -C 15 }
	} ElseIf($AppAutoDownload -eq 1) {
		DisplayOut 'Aciliyor App Auto Download...' -C 11
		...
		DisplayOut 'Kapatiliyor App Auto Download...' -C 12
	...
	If($UpdateMSProducts -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Updates for other Microsoft products...' -C 15 }
	} ElseIf($UpdateMSProducts -eq 1) {
		DisplayOut 'Aciliyor Updates for other Microsoft products...' -C 11
		...
		DisplayOut 'Kapatiliyor Updates for other Microsoft products...' -C 12
	...
	If($CheckForWinUpdate -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Check for Windows Update...' -C 15 }
	} ElseIf($CheckForWinUpdate -eq 1) {
		DisplayOut 'Aciliyor Check for Windows Update...' -C 11
		Remove-ItemProperty -Path $Path -Name 'SetDisableUXWUAccess' -Type DWord -Value 0
	} ElseIf($CheckForWinUpdate -eq 2) {
		DisplayOut 'Kapatiliyor Check for Windows Update...' -C 12
		New-ItemProperty -Path $Path -Name 'SetDisableUXWUAccess' -Type DWord -Value 1
	}

	If($WinUpdateType -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Windows Update Check Type...' -C 15 }
	...
	If($WinUpdateDownload -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Windows Update P2P...' -C 15 }
		...
		DisplayOut 'Kapatiliyor Windows Update P2P...' -C 12
		$Path1 = 'SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization'
		$Path = CheckSetPath "HKCU:\$Path1"
		Set-ItemProperty -Path $Path -Name 'SystemSettingsDownloadMode' -Type DWord -Value 3
		If($Win10Ver -eq 1507){
	...
	If($RestartOnUpdate -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Windows Update Automatic Restart...' -C 15 }
	} ElseIf($RestartOnUpdate -eq 1) {
		DisplayOut 'Aciliyor Windows Update Automatic Restart...' -C 11
		...
		DisplayOut 'Kapatiliyor Windows Update Automatic Restart...' -C 12
	...
	If($UpdateMSRT -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Malicious Software Removal Tool Update...' -C 15 }
	} ElseIf($UpdateMSRT -eq 1) {
		DisplayOut 'Aciliyor Malicious Software Removal Tool Update...' -C 11
		Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\MRT' -Name 'DontOfferThroughWUAU'
	} ElseIf($UpdateMSRT -eq 2) {
		DisplayOut 'Kapatiliyor Malicious Software Removal Tool Update...' -C 12
	...
	If($UpdateDriver -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Driver Update Through Windows Update...' -C 15 }
	} ElseIf($UpdateDriver -eq 1) {
		DisplayOut 'Aciliyor Driver Update Through Windows Update...' -C 11
		...
		DisplayOut 'Kapatiliyor Driver Update Through Windows Update...' -C 12
	...
	If($UpdateAvailablePopup -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Update Available Popup...' -C 15 }
	} ElseIf($UpdateAvailablePopup -eq 1) {
		DisplayOut 'Aciliyor Update Available Popup...' -C 11
		...
		DisplayOut 'Kapatiliyor Update Available Popup...' -C 12
		ForEach($File In $musnotification_files){
	...
	If($UAC -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor UAC Level...' -C 15 }
	} ElseIf($UAC -eq 1) {
	...
	If($SharingMappedDrives -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Sharing Mapped Drives between Users...' -C 15 }
	} ElseIf($SharingMappedDrives -eq 1) {
		DisplayOut 'Aciliyor Sharing Mapped Drives between Users...' -C 11
		Set-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System' -Name 'EnableLinkedConnections' -Type DWord -Value 1
	} ElseIf($SharingMappedDrives -eq 2) {
		DisplayOut 'Kapatiliyor Sharing Mapped Drives between Users...' -C 12
		Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System' -Name 'EnableLinkedConnections'
	}

	If($AdminShares -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Hidden Administrative Shares...' -C 15 }
	} ElseIf($AdminShares -eq 1) {
		DisplayOut 'Aciliyor Hidden Administrative Shares...' -C 11
		...
		DisplayOut 'Kapatiliyor Hidden Administrative Shares...' -C 12
		Set-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters' -Name 'AutoShareWks' -Type DWord -Value 0
	}

	If($Firewall -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Firewall...' -C 15 }
	} ElseIf($Firewall -eq 1) {
		DisplayOut 'Aciliyor Firewall...' -C 11
		...
		DisplayOut 'Kapatiliyor Firewall...' -C 12
	...
	If($WinDefender -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Windows Defender...' -C 15 }
	} ElseIf($WinDefender -eq 1) {
		DisplayOut 'Aciliyor Windows Defender...' -C 11
		...
		DisplayOut 'Kapatiliyor Windows Defender...' -C 12
		$Path = 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Run'
		If($Win10Ver -lt 1703){ $RegName = 'WindowsDefender' } Else{ $RegName = 'SecurityHealth' }
	...
	If($HomeGroups -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Home Groups Services...' -C 15 }
	} ElseIf($HomeGroups -eq 1) {
		DisplayOut 'Aciliyor Home Groups Services...' -C 11
		Set-Service 'HomeGroupListener' -StartupType Manual
		Set-Service 'HomeGroupProvider' -StartupType Manual
		Start-Service 'HomeGroupProvider'
	} ElseIf($HomeGroups -eq 2) {
		DisplayOut 'Kapatiliyor Home Groups Services...' -C 12
	...
	If($RemoteAssistance -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Remote Assistance...' -C 15 }
	} ElseIf($RemoteAssistance -eq 1) {
		DisplayOut 'Aciliyor Remote Assistance...' -C 11
		Set-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Remote Assistance' -Name 'fAllowToGetHelp' -Type DWord -Value 1
	} ElseIf($RemoteAssistance -eq 2) {
		DisplayOut 'Kapatiliyor Remote Assistance...' -C 12
		Set-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Remote Assistance' -Name 'fAllowToGetHelp' -Type DWord -Value 0
	}

	If($RemoteDesktop -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Remote Desktop...' -C 15 }
	} ElseIf($RemoteDesktop -eq 1) {
		DisplayOut 'Aciliyor Remote Desktop w/o Network Level Authentication...' -C 11
		...
		DisplayOut 'Kapatiliyor Remote Desktop...' -C 12
		$Path = 'HKLM:\SYSTEM\CurrentControlSet\Control\Terminal Server'
	...
	If($CastToDevice -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Cast to Device Context item...' -C 15 }
	} ElseIf($CastToDevice -eq 1) {
		DisplayOut 'Aciliyor Cast to Device Context item...' -C 11
		...
		DisplayOut 'Kapatiliyor Cast to Device Context item...' -C 12
	...
	If($PreviousVersions -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Previous Versions Context item...' -C 15 }
	} ElseIf($PreviousVersions -eq 1) {
		DisplayOut 'Aciliyor Previous Versions Context item...' -C 11
		...
		DisplayOut 'Kapatiliyor Previous Versions Context item...' -C 12
	...
	If($IncludeinLibrary -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Include in Library Context item...' -C 15 }
	} ElseIf($IncludeinLibrary -eq 1) {
		DisplayOut 'Aciliyor Include in Library Context item...' -C 11
		...
		DisplayOut 'Kapatiliyor Include in Library...' -C 12
		Set-ItemProperty -Path 'HKCR:\Folder\ShellEx\ContextMenuHandlers\Library Location' -Name '(Default)' -Type String -Value ''
	}

	If($PinToStart -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Pin To Start Context item...' -C 15 }
	} ElseIf($PinToStart -eq 1) {
		DisplayOut 'Aciliyor Pin To Start Context item...' -C 11
		...
		DisplayOut 'Kapatiliyor Pin To Start Context item...' -C 12
	...
	If($PinToQuickAccess -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Pin To Quick Access Context item...' -C 15 }
	} ElseIf($PinToQuickAccess -eq 1) {
		DisplayOut 'Aciliyor Pin To Quick Access Context item...' -C 11
		...
		DisplayOut 'Kapatiliyor Pin To Quick Access Context item...' -C 12
		RemoveSetPath 'HKCR:\Folder\shell\pintohome'
		RemoveSetPath 'HKLM:\SOFTWARE\Classes\Folder\shell\pintohome'
	}

	If($ShareWith -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Share With/Share Context item...' -C 15 }
	} ElseIf($ShareWith -eq 1) {
		DisplayOut 'Aciliyor Share With/Share Context item...' -C 11
		...
		DisplayOut 'Kapatiliyor Share/Share With...' -C 12
	...
	If($SendTo -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Send To Context item...' -C 15 }
	} ElseIf($SendTo -eq 1) {
		DisplayOut 'Aciliyor Send To Context item...' -C 11
		...
		DisplayOut 'Kapatiliyor Send To Context item...' -C 12
		RemoveSetPath 'HKCR:\AllFilesystemObjects\shellex\ContextMenuHandlers\SendTo'
	}

	BoxItem 'Task Bar Items'
	If($BatteryUIBar -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Battery UI Bar...' -C 15 }
	} ElseIf($BatteryUIBar -eq 1) {
		DisplayOut 'Aciliyor New Battery UI Bar...' -C 11
		...
		DisplayOut 'Aciliyor Old Battery UI Bar...' -C 12
	...
	If($ClockUIBar -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Clock UI Bar...' -C 15 }
	} ElseIf($ClockUIBar -eq 1) {
		DisplayOut 'Aciliyor New Clock UI Bar...' -C 11
		...
		DisplayOut 'Aciliyor Old Clock UI Bar...' -C 12
		$Path = CheckSetPath 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\ImmersiveShell'
		Set-ItemProperty -Path $Path -Name 'UseWin32TrayClockExperience' -Type DWord -Value 1
	}

	If($VolumeControlBar -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Volume Control Bar...' -C 15 }
	} ElseIf($VolumeControlBar -eq 1) {
		DisplayOut 'Aciliyor New Volume Control Bar (Horizontal)...' -C 11
		...
		DisplayOut 'Aciliyor Classic Volume Control Bar (Vertical)...' -C 12
	...
	If($TaskbarSearchBox -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Taskbar Search box / button...' -C 15 }
	...
	If($TaskViewButton -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Task View button...' -C 15 }
	...
	If($TaskbarIconSize -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Icon Size in Taskbar...' -C 15 }
	...
	If($TaskbarGrouping -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Taskbar Item Grouping...' -C 15 }
	...
	If($TrayIcons -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Tray icons...' -C 15 }
	...
	If($SecondsInClock -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Seconds in Taskbar Clock...' -C 15 }
	...
	If($LastActiveClick -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Last Active Click...' -C 15 }
	} ElseIf($LastActiveClick -eq 1) {
		DisplayOut 'Aciliyor Last Active Click...' -C 11
		...
		DisplayOut 'Kapatiliyor Last Active Click...' -C 12
	...
	If($TaskBarOnMultiDisplay -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Taskbar on Multiple Displays...' -C 15 }
	...
	If($TaskbarButtOnDisplay -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Taskbar Buttons on Multiple Displays...' -C 15 }
	...
	If($StartMenuWebSearch -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Bing Search in Start Menu...' -C 15 }
	} ElseIf($StartMenuWebSearch -eq 1) {
		DisplayOut 'Aciliyor Bing Search in Start Menu...' -C 11
		...
		DisplayOut 'Kapatiliyor Bing Search in Start Menu...' -C 12
	...
	If($StartSuggestions -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Start Menu Suggestions...' -C 15 }
	} ElseIf($StartSuggestions -eq 1) {
		DisplayOut 'Aciliyor Start Menu Suggestions...' -C 11
		...
		DisplayOut 'Kapatiliyor Start Menu Suggestions...' -C 12
		$Path = CheckSetPath 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager'
	...
	If($MostUsedAppStartMenu -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Most used Apps in Start Menu...' -C 15 }
	...
	If($RecentItemsFrequent -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Recent Items and Frequent Places...' -C 15 }
	} ElseIf($RecentItemsFrequent -eq 1) {
		DisplayOut 'Aciliyor Recent Items and Frequent Places...' -C 11
		...
		DisplayOut 'Kapatiliyor Recent Items and Frequent Places...' -C 12
		$Path = CheckSetPath 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\HideDesktopIcons\ClassicStartMenu'
	...
	If($AccessKeyPrmpt -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Accessibility Keys Prompts...' -C 15 }
	} ElseIf($AccessKeyPrmpt -eq 1) {
		DisplayOut 'Aciliyor Accessibility Keys Prompts...' -C 11
		...
		DisplayOut 'Kapatiliyor Accessibility Keys Prompts...' -C 12
		$Path = 'HKCU:\Control Panel\Accessibility\'
	...
	If($F1HelpKey -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor F1 Help key...' -C 15 }
	} ElseIf($F1HelpKey -eq 1) {
		DisplayOut 'Aciliyor F1 Help key...' -C 11
		RemoveSetPath 'HKCU:\Software\Classes\TypeLib\{8cec5860-07a1-11d9-b15e-000d56bfe6ee}\1.0\0'
	} ElseIf($F1HelpKey -eq 2) {
		DisplayOut 'Kapatiliyor F1 Help key...' -C 12
	...
	If($PidInTitleBar -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Process ID on Title Bar...' -C 15 }
	...
	If($AeroShake -eq 0) {
		...
		DisplayOut 'Kapatiliyor Aero Shake...' -C 12
	...
	If($KnownExtensions -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Known File Extensions...' -C 15 }
	...
	If($HiddenFiles -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Hidden Files...' -C 15 }
	...
	If($SystemFiles -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor System Files...' -C 15 }
	...
	If($ExplorerOpenLoc -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Default Explorer view to Quick Access...' -C 15 }
	...
	If($RecentFileQikAcc -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Recent Files in Quick Access...' -C 15 }
	...
	If($FrequentFoldersQikAcc -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Frequent Folders in Quick Access...' -C 15 }
	...
	If($WinContentWhileDrag -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Window Content while Dragging...' -C 15 }
	...
	If($Autoplay -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Autoplay...' -C 15 }
	} ElseIf($Autoplay -eq 1) {
		DisplayOut 'Aciliyor Autoplay...' -C 11
		Set-ItemProperty -Path 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers' -Name 'DisableAutoplay' -Type DWord -Value 0
	} ElseIf($Autoplay -eq 2) {
		DisplayOut 'Kapatiliyor Autoplay...' -C 12
		Set-ItemProperty -Path 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers' -Name 'DisableAutoplay' -Type DWord -Value 1
	}

	If($Autorun -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Autorun for all Drives...' -C 15 }
	} ElseIf($Autorun -eq 1) {
		DisplayOut 'Aciliyor Autorun for all Drives...' -C 11
		Remove-ItemProperty -Path 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer' -Name 'NoDriveTypeAutoRun'
	} ElseIf($Autorun -eq 2) {
		DisplayOut 'Kapatiliyor Autorun for all Drives...' -C 12
	...
	If($StoreOpenWith -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Search Windows Store for Unknown Extensions...' -C 15 }
	} ElseIf($StoreOpenWith -eq 1) {
		DisplayOut 'Aciliyor Search Windows Store for Unknown Extensions...' -C 11
		...
		DisplayOut 'Kapatiliyor Search Windows Store for Unknown Extensions...' -C 12
	...
	If($WinXPowerShell -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Win+X PowerShell to Command Prompt...' -C 15 }
	...
	If($TaskManagerDetails -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Task Manager Details...' -C 15 }
	...
	If($Win10Ver -ge 1709) {
		If($ReopenAppsOnBoot -eq 0) {
			If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Re-Opening Apps on Boot...' -C 15 }
			...
			DisplayOut "Kapatiliyor Re-Opening Apps on Boot (Apps won't reopen on boot)..." -C 12
	...
	If($Win10Ver -ge 1803) {
		If($Timeline -eq 0) {
			If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Windows Timeline...' -C 15 }
		} ElseIf($Timeline -eq 1) {
			DisplayOut 'Enableing Windows Timeline...' -C 11
			Set-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System' -Name 'EnableActivityFeed' -Type DWord -Value 1
		} ElseIf($Timeline -eq 2) {
			DisplayOut "Kapatiliyor Windows Timeline..." -C 12
			Set-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System' -Name 'EnableActivityFeed' -Type DWord -Value 0
		}
	}

	If($LongFilePath -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Long File Path...' -C 15 }
		...
		DisplayOut "Kapatiliyor Long File Path..." -C 12
	...
	If($AppHibernationFile -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor App Hibernation File (Swapfile.sys)...' -C 15 }
	} ElseIf($AppHibernationFile -eq 1) {
		DisplayOut 'Aciliyor App Hibernation File (Swapfile.sys)...' -C 11
		...
		DisplayOut 'Kapatiliyor App Hibernation File (Swapfile.sys)...' -C 12
		Set-ItemProperty -Path "HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" -Name "SwapfileControl" -Type Dword -Value 0
	}

	BoxItem "'This PC' Items"
	If($DesktopIconInThisPC -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Desktop folder in This PC...' -C 15 }
	...
	If($DocumentsIconInThisPC -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Documents folder in This PC...' -C 15 }
	...
	If($DownloadsIconInThisPC -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Downloads folder in This PC...' -C 15 }
	...
	If($MusicIconInThisPC -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Music folder in This PC...' -C 15 }
	...
	If($PicturesIconInThisPC -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Pictures folder in This PC...' -C 15 }
	...
	If($VideosIconInThisPC -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Videos folder in This PC...' -C 15 }
	...
	If($Win10Ver -ge 1709){
		If($ThreeDobjectsIconInThisPC -eq 0) {
			If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor 3D Object folder in This PC...' -C 15 }
	...
	If($ThisPCOnDesktop -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor This PC Icon on Desktop...' -C 15 }
	...
	If($NetworkOnDesktop -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Network Icon on Desktop...' -C 15 }
	...
	If($RecycleBinOnDesktop -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Recycle Bin Icon on Desktop...' -C 15 }
	...
	If($UsersFileOnDesktop -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Users File Icon on Desktop...' -C 15 }
	...
	If($ControlPanelOnDesktop -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Control Panel Icon on Desktop...' -C 15 }
	...
	If($PVFileAssociation -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Photo Viewer File Association...' -C 15 }
	...
	If($PVOpenWithMenu -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Photo Viewer Open with Menu...' -C 15 }
	...
	If($LockScreen -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Lock Screen...' -C 15 }
	} ElseIf($LockScreen -eq 1) {
		If($Win10Ver -In 1507,1511) {
			DisplayOut 'Aciliyor Lock Screen...' -C 11
			Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Personalization' -Name 'NoLockScreen'
		} ElseIf($Win10Ver -ge 1607) {
			DisplayOut 'Aciliyor Lock screen (removing scheduler workaround)...' -C 11
		...
		If($Win10Ver -In 1507,1511) {
			DisplayOut 'Kapatiliyor Lock Screen...' -C 12
			...
			DisplayOut 'Kapatiliyor Lock screen using scheduler workaround...' -C 12
	...
	If($PowerMenuLockScreen -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Power Menu on Lock Screen...' -C 15 }
	...
	If($CameraOnLockscreen -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Camera at Lockscreen...' -C 15 }
	} ElseIf($CameraOnLockscreen -eq 1) {
		DisplayOut 'Aciliyor Camera at Lockscreen...' -C 11
		...
		DisplayOut 'Kapatiliyor Camera at Lockscreen...' -C 12
		$Path = CheckSetPath 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Personalization'
	...
	If($Win10Ver -ge 1803) {
		If($AccountProtectionWarn -eq 0) {
			If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Account Protection Warning...' -C 15 }
		} ElseIf($AccountProtectionWarn -eq 1) {
			DisplayOut 'Aciliyor Account Protection Warning...' -C 11
			...
			DisplayOut 'Kapatiliyor Account Protection Warning...' -C 12
	...
	If($ActionCenter -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Action Center...' -C 15 }
	} ElseIf($ActionCenter -eq 1) {
		DisplayOut 'Aciliyor Action Center...' -C 11
		...
		DisplayOut 'Kapatiliyor Action Center...' -C 12
		$Path = CheckSetPath 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\Explorer'
	...
	If($StickyKeyPrompt -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Sticky Key Prompt...' -C 15 }
	} ElseIf($StickyKeyPrompt -eq 1) {
		DisplayOut 'Aciliyor Sticky Key Prompt...' -C 11
		Set-ItemProperty -Path 'HKCU:\Control Panel\Accessibility\StickyKeys' -Name 'Flags' -Type String -Value '510'
	} ElseIf($StickyKeyPrompt -eq 2) {
		DisplayOut 'Kapatiliyor Sticky Key Prompt...' -C 12
		Set-ItemProperty -Path 'HKCU:\Control Panel\Accessibility\StickyKeys' -Name 'Flags' -Type String -Value '506'
	}

	If($NumblockOnStart -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Num Lock on Startup...' -C 15 }
	} ElseIf($NumblockOnStart -eq 1) {
		DisplayOut 'Aciliyor Num Lock on Startup...' -C 11
		Set-ItemProperty -Path 'HKU:\.DEFAULT\Control Panel\Keyboard' -Name 'InitialKeyboardIndicators' -Type DWord -Value 2147483650
	} ElseIf($NumblockOnStart -eq 2) {
		DisplayOut 'Kapatiliyor Num Lock on Startup...' -C 12
		Set-ItemProperty -Path 'HKU:\.DEFAULT\Control Panel\Keyboard' -Name 'InitialKeyboardIndicators' -Type DWord -Value 2147483648
	}

	If($F8BootMenu -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor F8 boot menu options...' -C 15 }
	} ElseIf($F8BootMenu -eq 1) {
		DisplayOut 'Aciliyor F8 boot menu options...' -C 11
		bcdedit /set `{current`} bootmenupolicy Legacy | Out-Null
	} ElseIf($F8BootMenu -eq 2) {
		DisplayOut 'Kapatiliyor F8 boot menu options...' -C 12
		bcdedit /set `{current`} bootmenupolicy Standard | Out-Null
	}

	If($RemoteUACAcctToken -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Remote UAC Local Account Token Filter...' -C 15 }
	} ElseIf($RemoteUACAcctToken -eq 1) {
		DisplayOut 'Aciliyor Remote UAC Local Account Token Filter...' -C 11
		...
		DisplayOut 'Kapatiliyor  Remote UAC Local Account Token Filter...' -C 12
	...
	If($HibernatePower -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Hibernate Option...' -C 15 }
	} ElseIf($HibernatePower -eq 1) {
		DisplayOut 'Aciliyor Hibernate Option...' -C 11
		...
		DisplayOut 'Kapatiliyor Hibernate Option...' -C 12
		Set-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Power' -Name 'HibernateEnabled' -Type DWord -Value 0
		powercfg /HIBERNATE OFF
	}

	If($SleepPower -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Sleep Option...' -C 15 }
	} ElseIf($SleepPower -eq 1) {
		DisplayOut 'Aciliyor Sleep Option...' -C 11
		...
		DisplayOut 'Kapatiliyor Sleep Option...' -C 12
		Set-ItemProperty -Path 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FlyoutMenuSettings' -Name 'ShowSleepOption' -Type DWord -Value 0
	}

	If($UnpinItems -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Unpinning Items...' -C 15 }
	...
	If($DisableVariousTasks -eq 0) {
		#If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor  Various Scheduled Tasks...' -C 15 }
	} ElseIf($DisableVariousTasks -eq 1) {
		DisplayOut "`nAciliyor Various Scheduled Tasks...`n------------------" -C 12
	...
	If($OneDrive -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor OneDrive...' -C 15 }
	} ElseIf($OneDrive -eq 1) {
		DisplayOut 'Aciliyor OneDrive...' -C 11
		Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\OneDrive' -Name 'DisableFileSyncNGSC'
		Set-ItemProperty -Path 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced' -Name 'ShowSyncProviderNotifications' -Type DWord -Value 1
	} ElseIf($OneDrive -eq 2) {
		DisplayOut 'Kapatiliyor OneDrive...' -C 12
	...
	If($OneDriveInstall -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor OneDrive Installing...' -C 15 }
	...
	If($XboxDVR -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Xbox DVR...' -C 15 }
	} ElseIf($XboxDVR -eq 1) {
		DisplayOut 'Aciliyor Xbox DVR...' -C 11
		Set-ItemProperty -Path 'HKCU:\System\GameConfigStore' -Name 'GameDVR_Enabled' -Type DWord -Value 1
		Remove-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\GameDVR' -Name 'AllowGameDVR'
	} ElseIf($XboxDVR -eq 2) {
		DisplayOut 'Kapatiliyor Xbox DVR...' -C 12
	...
	If($MediaPlayer -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Windows Media Player...' -C 15 }
	...
	If($WorkFolders -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Work Folders Client...' -C 15 }
	...
	If($FaxAndScan -eq 0) {
		If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Fax And Scan...' -C 15 }
	...
	If($Win10Ver -ge 1607) {
		If($LinuxSubsystem -eq 0) {
			If($ShowSkipped -eq 1){ DisplayOut 'Atlaniyor Linux Subsystem...' -C 15 }
	...
	If($Restart -eq 1 -And $Release_Type -eq 'Tasinabilir') {
		Clear-Host
		ThanksDonate
		$Seconds = 15
		DisplayOut "`nYeniden Baslatiliyor ",$Seconds,' Sure...' -C 15,11,15
		$Message = 'Yeniden Baslatiliyor'
		Start-Sleep -Seconds 1
		ForEach($Count In (1..$Seconds)){ If($Count -ne 0){ DisplayOut $Message," $($Seconds - $Count)" -C 15,11 ;Start-Sleep -Seconds 1 } }
		DisplayOut 'Bilgisayar Yeniden Basliyor...' -C 13
		Restart-Computer
	} ElseIf($Release_Type -eq 'Tasinabilir') {
		DisplayOut 'Gorusuruz...' -C 13
		If($Automated -eq 0){ Read-Host -Prompt "`nCikmak icin Bir Tusa Basiniz.." }
		Exit
	} ElseIf($Automated -eq 0) {
		ThanksDonate
		Read-Host -Prompt "`nCikmak icin Bir Tusa Basiniz.."
	}
}
...
$Script:RestorePointName = "CapsWin10_SistemGeriYukleme"
...
# Note: If found will Auto download and runs that, File name will be "CapsWin10.ps1"
...
#Restart when done? (I recommend reBaslatiliyor when done)
